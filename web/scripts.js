			...
			if (selectedWindow == "none") {
				...
				$('#menu').html(`
					<div class="d-flex justify-content-center flex-column align-items-center">
						...
						<br>
						<div style="font-size: 40px; color: #fff;">Data aan het laden...</div>
					</div>
				`);
				$("#menu").fadeIn();
				$(".main_card").fadeIn();
							...
							<div class="d-flex justify-content-between align-items-center">
								...
								<div>
									...
									<div style="font-size: 14px; margin-top: -12px; font-weight: 500; position: absolute; right: 7.2%;">
										<span>Portemonnee: <span id="wallet_money"></span> EUR</span>
									</div>
								</div>
							</div>
							<hr>
		...
		case 'transactions_page':
			...
			if (event.data.isInSociety) {
				society = `<span class="sidebar-title mt-5">Society</span>
						   ...
						   <p class="sidebar-item" id="society_transactions" style="margin-bottom: 12px;"><i class="fas fa-exchange-alt"></i> <span class="ms-1">Transacties</span></p>`;
			} else {
				society = '';
			}
			...
			$('#sidebar').html(`
				...
				<p class="sidebar-item selected" id="transactions_page" style="margin-bottom: 12px;"><i class="fas fa-exchange-alt"></i> <span class="ms-1">Transacties</span></p>
				<p class="sidebar-item mt-2" id="settings_page" style="margin-bottom: 12px;"><i class="fas fa-cog"></i> <span class="ms-1">Instellingen</span></p>
				${society}
			`);
			...
			for (var i = 0; i < num; i++) {
				...
				if (db.type == 'transfer' && db.receiver_identifier == event.data.identifier) {
					...
					data = `<td class="align-middle" style="font-weight: 500;">
								Van <span style="color: #1f5eff; font-weight: 600;">${db.sender_name}</span>
								<div style="margin-top: -5px;">Ontvangen</div>
							</td>`;
					...
					data = `<td class="align-middle" style="font-weight: 500;">
								...
								<div style="margin-top: -5px;">Gestuurd</div>
							</td>`;
					...
					icon = '<td class="align-middle"><span style="background-color: #1d1e24; padding: 10px 15px 10px 15px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>';
					data = `<td class="align-middle" style="font-weight: 500;">
								Naar <span style="color: #1f5eff; font-weight: 600;">${db.receiver_name}</span>
								<div style="margin-top: -5px;">Gestort</div>
							</td>`;
					amount = `<td class="align-middle" style="font-weight: 500;"><span style="color: #2ecc71; float: right;">+ ${db.value.toLocaleString()} EUR</span> </td>`;
					// Withdrawn
					...
					data = `<td class="align-middle" style="font-weight: 500;">
								Van <span style="color: #1f5eff; font-weight: 600;">${db.sender_name}</span>
								<div style="margin-top: -5px;">Gepakt</div>
							</td>`;
					amount = `<td class="align-middle" style="font-weight: 500;"><span style="float: right;"> - ${db.value.toLocaleString()} EUR</span> </td>`;
				}
			...
			$('#page_info').html(`
				<div class="row mb-3">
					<div class="col col-md-3">
						<div class="card" style="background-color: #1f5eff; border-radius: 10px; color: #fff;">
						  <div class="card-body text-center">
						    <h6 class="card-title" style="font-weight: 600; font-size: 20px;">TRANSACTIES</h6>
					...
					<div class="col col-md-3">
						<div class="card" style="background-color: #1f5eff; border-radius: 10px; color: #fff;">
						  <div class="card-body text-center">
						    <h6 class="card-title" style="font-weight: 600; font-size: 20px;">INKOMEN</h6>
					...
					<div class="col col-md-3">
						<div class="card" style="background-color: #1f5eff; border-radius: 10px; color: #fff;">
						  <div class="card-body text-center">
						    <h6 class="card-title" style="font-weight: 600; font-size: 20px;">UITGAVEN</h6>
					...
					<div class="col col-md-3">
						<div class="card" style="background-color: #1f5eff; border-radius: 10px; color: #fff;">
						  <div class="card-body text-center">
						    <h6 class="card-title" style="font-weight: 600; font-size: 20px;">INKOMSTEN</h6>
					...
					<tbody id="transactionsData">
						<tr>
							...
							<td class="align-middle" style="font-weight: 500; font-size: 16px;">
								Naar <span style="color: #1f5eff;">Arthur James</span>
								<div style="margin-top: -5px;">Gestuurd</div>
							</td>
						...
						<tr>
							...
							<td class="align-middle" style="font-weight: 500; font-size: 16px;">
								Naar <span style="color: #1f5eff;">Bank Account</span>
								<div style="margin-top: -5px;">Gestort</div>
							</td>
							<td class="align-middle" style="font-weight: 500;">28 Aug 04:43</td>
		...
		case 'society_transactions':
			...
			for (var i = 0; i < num; i++) {
				...
				if (db.type == 'transfer' && db.receiver_identifier == event.data.identifier) {
					...
					data = `<td class="align-middle" style="font-weight: 500;">
								Van <span style="color: #1f5eff; font-weight: 600;">${db.sender_name}</span>
								<div style="margin-top: -5px;">Afgenomen</div>
							</td>`;
					amount = `<td class="align-middle" style="font-weight: 500;"><span style="float: right;"> - ${db.value.toLocaleString()} EUR</span> </td>`;
				}
					...
					<tbody id="transactionsData">
						<tr>
							...
							<td class="align-middle" style="font-weight: 500; font-size: 16px;">
								...
								<div style="margin-top: -5px;">Verzonden</div>
							</td>
							<td class="align-middle" style="font-weight: 500;">28 Aug 04:43</td>
							<td class="align-middle" style="font-weight: 500;">- 732 500 EUR</td>
						</tr>
...
$(document).on('click', "#overview_page", function () {
	$.post('https://zv-banking/action', JSON.stringify({
		...
		<div class="col-md-7" style="border-right: 1px solid rgba(62, 63, 75);">
			<div class="card text-center" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75);">
				<div class="card-header" style="background-color: #292a31; border-top-right-radius: 10px; border-top-left-radius: 10px;">
					<span style="color: #fff; font-size: 18px;"><i class="fas fa-chart-line"></i> Statistieken</span>
				</div>
				...
				<div class="col-md-12">
					<div class="card h-100" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75); margin-top: 12px;">
						<div class="card-header text-center" style="background-color: #292a31; border-top-right-radius: 10px; border-top-left-radius: 10px;">
							<span style="color: #fff; font-size: 18px;"><span><i class="fas fa-exchange-alt"></i> Laatste transactie</span> <span class="badge bg-primary viewall-badge" style="position: absolute; font-size: 14px; right: 9px; top: 10px;" id="view_all_transactions"><i class="fas fa-eye"></i> VIEW ALL</span></span>
						</div>
							...
							<table id="lastTransactionsTable">
								<tbody id="lastTransactionsData">
									...
									<tr>
										<td class="align-middle"><span style="background-color: #1d1e24; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-upload"></i></span></td>
										<td class="align-middle" style="font-weight: 500; font-size: 16px;">
											Van <span style="color: #1f5eff;">Arthur James</span>
											<div style="margin-top: -5px;">Received</div>
										</td>
									...
									<tr>
										<td class="align-middle"><span style="background-color: #1d1e24; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>
										<td class="align-middle" style="font-weight: 500; font-size: 16px;">
											Van <span style="color: #1f5eff;">Bank Account</span>
											<div style="margin-top: -5px;">Afgenomen</div>
										</td>
		...
		<div class="col-md-5">
			<div class="col-md-12">
				<div class="card" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75);">
					<div class="card-header text-center" style="background-color: #292a31; border-top-right-radius: 10px; border-top-left-radius: 10px;">
						<span style="color: #fff; font-size: 18px;"><i class="bi bi-credit-card-fill"></i> Informatie</span>
					</div>
					<div class="card-body" style="background-color: #1d1e24; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px; font-size: 16px;">
						<div class="card creditcard-classic_card d-flex align-items-center" style="margin: 0 auto; margin-bottom: 16px;">
							<div class="card-body creditcard-classic_card-body">
								<span class="d-flex justify-content-between"><span><img src="visa_white.svg" style="width: 20%;"><span style="color: #fff; font-size: 12px; margin-left: 5px; font-weight: 500;">ZandVisa</span></span><span><i class="fas fa-wifi"></i></span></span>
				...
				<div class="card text-center h-100" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75); margin-top: 12px;">
					...
					<div class="card-body" style="background-color: #1d1e24; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">
						<div class="d-flex justify-content-center">
							<button type="button" id="depositMoneyModal" class="btn btn-blue flex-grow-1" style="border-radius: 10px; flex-basis: 100%;" data-bs-toggle="modal" data-bs-target="#depositModal"><i class="bi bi-upload"></i> Storten</button>
						</div>
						<div class="d-flex justify-content-center" style="margin-top: 7px;">
							<button type="button" id="withdrawMoneyModal" class="btn btn-blue flex-grow-1" style="border-radius: 10px; flex-basis: 100%;" data-bs-toggle="modal" data-bs-target="#withdrawModal"><i class="bi bi-download"></i> Afnemen</button>
						</div>
						<div class="d-flex justify-content-center" style="margin-top: 7px;">
...
function settings_page_function(event) {
	...
	$('#sidebar').html(`
		<p class="sidebar-item mt-2" id="overview_page" style="margin-bottom: 12px;"><i class="bi bi-grid-1x2-fill"></i> <span class="ms-1">Overview</span></p>
		<p class="sidebar-item" id="transactions_page" style="margin-bottom: 12px;"><i class="fas fa-exchange-alt"></i> <span class="ms-1">Transactions</span></p>
		<p class="sidebar-item mt-2 selected" id="settings_page" style="margin-bottom: 12px;"><i class="fas fa-cog"></i> <span class="ms-1">Instellingen</span></p>
		${society}
	`);
						...
						<div class="row">
							<div class="col col-md-6 d-flex justify-content-center">
								<div class="card w-100 h-100" style="background-color: #292a31; border-radius: 10px; color: #fff;">
								  <div class="card-body text-center">
								    <span style="font-size: 24px; color: #fff;">Verander IBAN</span>
							...
							<div class="col col-md-6 d-flex align-items-center">
								<div class="card w-100 h-100 d-flex justify-content-center" style="background-color: #1f5eff; border-radius: 10px; color: #fff;">
								  <div class="card-body text-center" style="font-size: 18px;">
								    <span>De IBAN heeft een wijzigingskosten van ${event.data.ibanCost}€</span>
								    <hr style="color: #fff;">
								    <span>De IBAN heeft altijd het voorvoegsel "${event.data.ibanPrefix}"</span>
								    <hr style="color: #fff;">
									<span>Het maximum aantal karakters is ${event.data.ibanCharNum}</span>
								  </div>
								</div>
							</div>
						</div>
					...
					<div class="">
						<div class="row">
							<div class="col col-md-6 d-flex justify-content-center">
								<div class="card w-100 h-100" style="background-color: #292a31; border-radius: 10px; color: #fff;">
								  <div class="card-body text-center">
								    <span style="font-size: 24px; color: #fff;">Verander PIN</span>
							...
							<div class="col col-md-6 d-flex align-items-center">
								<div class="card w-100 h-100 d-flex justify-content-center" style="background-color: #1f5eff; border-radius: 10px; color: #fff;">
								  <div class="card-body text-center" style="font-size: 18px;">
								    <span>De pincode heeft een wijzigingskosten van ${event.data.pinCost}€</span>
								    <hr style="color: #fff;">
									<span>Het maximum aantal karakters is ${event.data.pinCharNum}</span>
									<hr style="color: #fff;">
									<span>Je kan alleen nummers gebruiken</span>
								  </div>
								</div>
							</div>
						</div>
	...
	setTimeout(function () {
		$('#menu').html(`
			<div class="d-flex justify-content-center flex-column align-items-center">
				<span class="load"></span>
				<br>
				<div style="font-size: 40px; color: #fff;">Uitloggen...</div>
			</div>
		`);
		$("#menu").fadeIn();
